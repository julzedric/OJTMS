...
<head>
  ...
  <title>OJTMS | Step Requirements</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="step-requirement.html">
            <i class="fa fa-folder-open-o"></i> <span>Steps Requirement</span>
          </a>
        </li>
        <li>
          <a href="announcement-list.html">
    ...
    <div class="box-body">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body padding-20">
                <form action="update_announcement.php" class="form-horizontal row-border" role="form" method="POST" id="ojtmsForm" enctype="multipart/form-data">
